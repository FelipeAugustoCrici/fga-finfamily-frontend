  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
      ...
      <div style={{ minWidth: 0 }}>
        ...
        <p style={{
          fontSize: 13, fontWeight: 600, color: t.text.primary, margin: 0,
    ...
    <div style={{
      ...
      <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ transition: 'opacity 0.2s ease' }}>
          <p style={{ fontSize: 10, color: t.text.subtle, margin: '0 0 4px', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
            Valor
          </p>
          <p style={{
